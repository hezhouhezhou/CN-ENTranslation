...
# # Feed the input IDs and input mask to the trained model to obtain the logits
# with torch.no_grad():
...
# def mltask(input_ids, input_mask):
#     # Randomly mask some tokens in the input sequence
#     masked_input_ids = input_ids.clone().to('mps')
#     masked_input_ids[input_mask == 1] = tokenizer.mask_token_id
